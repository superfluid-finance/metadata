...
```js
import meta from "@superfluid-finance/metadata"
console.log(sfMeta.networks.length)
// 12
console.log(sfMeta.testnets.length)
// 7
console.log(sfMeta.mainnets.length)
// 5
console.log(sfMeta.mainnets.filter(n => n.nativeTokenSymbol === "ETH").map(n => n.name))
// [
//   'eth-goerli',
//   'optimism-goerli',
//   'arbitrum-goerli',
...
//   'arbitrum-one'
// ]
console.log(m.getNetworkByChainId(10))
// {
